...
export function EventBlock({
  ...
  return (
    <button
      ...
      style={style}
      className="z-10 block content-start overflow-hidden border-t border-ink/60 bg-event px-1 pt-px text-left align-top transition-colors duration-100 hover:bg-event-hover active:bg-event-active focus-visible:outline-2 focus-visible:outline-spot"
    >
