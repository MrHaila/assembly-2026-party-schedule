...
export function EventBlock({
  ...
  return (
    <div
      ...
      style={style}
      className={`group relative z-10 overflow-hidden border transition-colors duration-100${favourite ? " event-favourite" : " border-strong bg-event hover:bg-event-hover active:bg-event-active"}${live ? " live-stripes" : ""}${past ? " opacity-45 saturate-50 hover:opacity-100" : ""}`}
    >
