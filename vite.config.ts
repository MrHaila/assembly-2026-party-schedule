  ...
  vite: {
    plugins: [
      ...
      VitePWA({
        ...
        workbox: {
          // The generated client/index.html is the offline app shell. It loads
          // the hashed client assets and lets the client render the schedule.
          navigateFallback: "client/index.html",
          // Never serve the app shell fallback for API or OAuth routes.
          navigateFallbackDenylist: [/^\/api\//, /^\/~oauth/],
          globPatterns: [
            "**/*.{js,css,html,woff2,woff,png,svg,ico,webmanifest}",
          ],
          // Runtime caches for external fonts and data APIs.
          runtimeCaching: [
            {
